...
//                         childref={(input) => this.value1 = input}
//                     />
//                 </div>
//                 <div className='row'>
...
//                         childref={(input) => this.value2 = input}
//                     />
//                 </div>
//                 <div className='row'>
...
//                         childref={(input) => this.value3 = input}
//                     />
//                 </div>
//                 <div className='row'>
...
//                     childref={(input) => this.value4 = input}
//                     />
//                 </div>
//                 <div className='row'>
...
//                         childref={(input) => this.value5 = input}
//                     />
//                 </div>
//                 <div className='row'>
...
//                         childref={(input) => this.value6 = input}
//                     />
//                 </div>
//                 <div className='row'>
...
class Popup extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        const value1 = this.getValue1.value
        const value2 = this.getValue2.value
        const value3 = this.getValue3.value
        const value4 = this.getValue4.value
        const value5 = this.getValue5.value
        const value6 = this.getValue6.value
        const seller = this.getSeller.value
        ...
        this.getPhone.value = ''
        this.getValue1.value = 0
        this.getValue2.value = 0
        this.getValue3.value = 0
        this.getValue4.value = 0
        this.getValue5.value = 0
        this.getValue6.value = 0
        this.getSeller.value = 0
        this.getTotal.value = 0

        this.props.closePopupAndSave()
        ...
        return (
            <div className='popup'>
                ...
                <div className='Header'>
                    <p><strong>Invoice #{this.props.ID}</strong>
                        <i>
                        ...
                        <div className='two column row'>
                            <div className='column'>
                                <div>
                                    ...
                                    <button className="ui orange button btnSave" onClick={this.handleSubmit}>
                                        <i className="save icon"></i>{this.props.buttonName}
                                    </button>
